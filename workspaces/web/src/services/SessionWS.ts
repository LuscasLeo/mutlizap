...
//     // on<U extends keyof IncomingEvents>(
//     //   event: U, listener: IncomingEvents[U]
//     // ): this;
  
//     // emit<U extends keyof OutgoingEvents>(
//     //   event: U, ...args: Parameters<OutgoingEvents[U]>
//     // ): boolean;
